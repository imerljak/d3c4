...
function Structurizr({ dsl, className, defaultView, defaultEngine, defaultMode, }) {
    ...
    const fullscreenRef = (0, react_1.useRef)(null);
    ...
    if (!workspace)
        return null;
    return ((0, jsx_runtime_1.jsxs)("div", { className: (0, clsx_1.default)('structurizr-container', className), ref: fullscreenRef, children: [(0, jsx_runtime_1.jsxs)("div", { className: "structurizr-toolbar", children: [(0, jsx_runtime_1.jsxs)("select", { value: selectedView ?? '', onChange: (e) => setSelectedView(e.target.value), className: "structurizr-select", title: "Select Workspace View", children: [views.length === 0 && (0, jsx_runtime_1.jsx)("option", { value: "", disabled: true, children: "No views found" }), views.map(({ key, title, description }) => {
                                const label = title && description ? `${title} — ${description}`
                                    : title ?? description ?? key;
                                return (0, jsx_runtime_1.jsx)("option", { value: key, children: label }, key);
                            })] }), (0, jsx_runtime_1.jsxs)("div", { className: "structurizr-toggles", children: [(0, jsx_runtime_1.jsx)("button", { className: "structurizr-btn-icon", onClick: toggleFullscreen, title: isFullscreen ? 'Exit fullscreen' : 'Enter fullscreen', "aria-label": isFullscreen ? 'Exit fullscreen' : 'Enter fullscreen', children: isFullscreen ? ((0, jsx_runtime_1.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [(0, jsx_runtime_1.jsx)("path", { d: "M8 3v3a2 2 0 0 1-2 2H3" }), (0, jsx_runtime_1.jsx)("path", { d: "M21 8h-3a2 2 0 0 1-2-2V3" }), (0, jsx_runtime_1.jsx)("path", { d: "M3 16h3a2 2 0 0 1 2 2v3" }), (0, jsx_runtime_1.jsx)("path", { d: "M16 21v-3a2 2 0 0 1 2-2h3" })] })) : ((0, jsx_runtime_1.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [(0, jsx_runtime_1.jsx)("path", { d: "M8 3H5a2 2 0 0 0-2 2v3" }), (0, jsx_runtime_1.jsx)("path", { d: "M21 8V5a2 2 0 0 0-2-2h-3" }), (0, jsx_runtime_1.jsx)("path", { d: "M3 16v3a2 2 0 0 0 2 2h3" }), (0, jsx_runtime_1.jsx)("path", { d: "M16 21h3a2 2 0 0 0 2-2v-3" })] })) }), allowedEngines.length > 1 && ((0, jsx_runtime_1.jsx)("select", { value: engine, onChange: (e) => setEngine(e.target.value), className: "structurizr-select", title: "Select Render Engine", children: allowedEngines.map(e => ((0, jsx_runtime_1.jsx)("option", { value: e, children: ENGINE_LABELS[e] }, e))) })), allowedModes.length > 1 && ((0, jsx_runtime_1.jsx)("select", { value: mode, onChange: (e) => setMode(e.target.value), className: "structurizr-select", title: "Select Display Mode", children: allowedModes.map(m => ((0, jsx_runtime_1.jsx)("option", { value: m, children: MODE_LABELS[m] }, m))) }))] })] }), (0, jsx_runtime_1.jsxs)("div", { className: (0, clsx_1.default)('structurizr-content', `mode-${mode}`), ref: containerRef, children: [mode === 'split' && ((0, jsx_runtime_1.jsx)("div", { className: "structurizr-code-panel", style: { flexBasis: `${codePanelWidthPct}%`, flexGrow: 0, flexShrink: 0 }, children: (0, jsx_runtime_1.jsx)("pre", { children: (0, jsx_runtime_1.jsx)("code", { children: dsl }) }) })), mode === 'split' && ((0, jsx_runtime_1.jsx)("div", { className: "structurizr-resizer", onPointerDown: handlePointerDown, role: "separator", "aria-orientation": "vertical", "aria-label": "Resize panels" })), (0, jsx_runtime_1.jsxs)("div", { className: "structurizr-diagram-panel", children: [selectedView && ((0, jsx_runtime_1.jsx)(react_2.D3C4Diagram, { workspace: workspace, viewKey: selectedView, engine: engine, onNavigate: setSelectedView, style: { height: '100%', width: '100%' } })), !selectedView && (0, jsx_runtime_1.jsx)("div", { className: "structurizr-empty", children: "No views defined in DSL" })] })] })] }));
}
